...
# Omregner sigma til skaleringsparameter til beregningen af VaR
...
# --------------------------------------------
# 8. VISUALISERING 2: Sammenlignende Histogram 
# --------------------------------------------
...
# 3. Plot Teoretisk t-fordeling fordeling (Orange, stiplet)
